...
function renderIcedCoffee (data){
 ...
 $('#ingredient11').text(data[3].ingredients[0]);
 $('#ingredient12').text(data[3].ingredients[1]);
 $('#ingredient13').text(data[3].ingredients[2]);
 ...
 $('#description6').text(data[5].description);
 $('#ingredient18').text(data[5].ingredients[0]);
 $('#ingredient19').text(data[5].ingredients[1]);
 $('#ingredient20').text(data[5].ingredients[2]);
 $('#ingredient21').text(data[5].ingredients[3]);
...
fetch(baseURL)
  .then(resp => resp.json())
  .then(data => renderIcedCoffee(data));
